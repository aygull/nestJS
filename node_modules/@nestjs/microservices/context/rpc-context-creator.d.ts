...
export declare class RpcContextCreator {
    ...
    create(instance: Controller, callback: (data: any, ...args: any[]) => Observable<any>, module: string, contextId?: import("@nestjs/core/injector/instance-wrapper").ContextId, inquirerId?: string): (...args: any[]) => Promise<Observable<any>>;
