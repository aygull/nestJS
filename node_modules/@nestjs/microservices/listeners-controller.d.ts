...
export declare class ListenersController {
    ...
    createRequestScopedHandler(wrapper: InstanceWrapper, pattern: PatternMetadata, module: Module, moduleKey: string, methodKey: string): (...args: unknown[]) => Promise<import("rxjs").Observable<any>>;
